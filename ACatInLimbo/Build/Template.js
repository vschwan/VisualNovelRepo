    ...
    async function Bay() {
        ...
        if (ACatInLimbo.dataForSave.visitedBay == true) {
            ...
            if (ACatInLimbo.dataForSave.visitedLakeTwice == true) {
                ...
                await ACatInLimbo.ƒS.Inventory.add(ACatInLimbo.items.Fish);
                await ACatInLimbo.ƒS.Inventory.add(ACatInLimbo.items.Fish);
                await ACatInLimbo.ƒS.Inventory.add(ACatInLimbo.items.Fish);
                await ACatInLimbo.ƒS.update();
                ACatInLimbo.ƒS.Text.print("A coin an three fishes have been added to your inventory");
                await ACatInLimbo.ƒS.Character.hide(ACatInLimbo.characters.bayCreature);
...
(function (ACatInLimbo) {
    async function Clouds() {
        ...
        await ACatInLimbo.ƒS.Character.show(ACatInLimbo.characters.pinkCat, ACatInLimbo.characters.pinkCat.pose.crouchedLookingAway, ACatInLimbo.ƒS.positionPercent(80, 99));
        ...
        await ACatInLimbo.ƒS.update();
        await ACatInLimbo.ƒS.Character.hide(ACatInLimbo.characters.pinkCat);
        await ACatInLimbo.ƒS.Character.show(ACatInLimbo.characters.pinkCat, ACatInLimbo.characters.pinkCat.pose.crouched, ACatInLimbo.ƒS.positionPercent(80, 99));
        await ACatInLimbo.ƒS.update();
        ...
        await ACatInLimbo.ƒS.update();
        await ACatInLimbo.ƒS.Character.hide(ACatInLimbo.characters.pinkCat);
        await ACatInLimbo.ƒS.Character.show(ACatInLimbo.characters.pinkCat, ACatInLimbo.characters.pinkCat.pose.thoughtful2, ACatInLimbo.ƒS.positionPercent(80, 99));
        await ACatInLimbo.ƒS.update();
        ...
        if (ACatInLimbo.dataForSave.pathMountainClouds == true) {
            ...
            await ACatInLimbo.ƒS.update();
            await ACatInLimbo.ƒS.Character.hideAll();
            await ACatInLimbo.ƒS.Character.show(ACatInLimbo.characters.pinkCat, ACatInLimbo.characters.pinkCat.pose.derpy1, ACatInLimbo.ƒS.positionPercent(80, 99));
            await ACatInLimbo.ƒS.Character.show(ACatInLimbo.characters.skyworm, ACatInLimbo.characters.skyworm.pose.friendly, ACatInLimbo.ƒS.positionPercent(50, 50));
            await ACatInLimbo.ƒS.update();
            ...
            await ACatInLimbo.ƒS.update();
            await ACatInLimbo.ƒS.Character.hide(ACatInLimbo.characters.pinkCat);
            await ACatInLimbo.ƒS.Character.show(ACatInLimbo.characters.pinkCat, ACatInLimbo.characters.pinkCat.pose.curious, ACatInLimbo.ƒS.positionPercent(80, 99));
            await ACatInLimbo.ƒS.update();
...
(function (ACatInLimbo) {
    async function Empty() {
        ...
        let endButtonsRequest = await ACatInLimbo.ƒS.Menu.getInput(endButtons, "choicesCSSClass");
...
(function (ACatInLimbo) {
    async function Forest() {
        ...
        await ACatInLimbo.ƒS.Character.animate(ACatInLimbo.characters.pinkCat, ACatInLimbo.characters.pinkCat.pose.scared, ACatInLimbo.ScaredCatAnimation());
        await ACatInLimbo.ƒS.update();
        await ACatInLimbo.ƒS.Speech.tell(ACatInLimbo.characters.protagonist, "Uaaaah, fuck fuck fuck fuck, LET'S RUN!!!!");
        await ACatInLimbo.ƒS.update();
...
(function (ACatInLimbo) {
    async function Gate() {
        ...
        ACatInLimbo.dataForSave.catScore += 80;
        document.getElementsByName("catScore").forEach(meterStuff => meterStuff.hidden = false);
        document.getElementById("scoreForCat").style.display = "";
        ACatInLimbo.ƒS.Speech.hide(); //Sprachfenster ausblenden
        ...
        //     await ƒS.update();
        //     await ƒS.Character.hide(characters.pinkCat);
        //     await ƒS.Character.show(characters.pinkCat, characters.pinkCat.pose.proud, ƒS.positionPercent(80, 99));
        //     await ƒS.Character.hide(characters.death);
        ...
        //     await ƒS.Speech.tell(characters.death, "I'm glad I did the right thing.");
        //     await ƒS.update();
        // }
        // await ƒS.Character.hide(characters.death);
        ...
        // await ƒS.update();
        // await ƒS.Character.hide(characters.pinkCat);
        // await ƒS.Character.show(characters.pinkCat, characters.pinkCat.pose.normal2, ƒS.positionPercent(80, 99));
        // await ƒS.update();
        ...
        // await ƒS.update();
        // await ƒS.Character.hide(characters.pinkCat);
        // await ƒS.Character.show(characters.pinkCat, characters.pinkCat.pose.talkingSad, ƒS.positionPercent(80, 99));
        // await ƒS.update();
        ...
        // await ƒS.update();
        // await ƒS.Character.hide(characters.pinkCat);
        // await ƒS.Character.show(characters.pinkCat, characters.pinkCat.pose.normalSad, ƒS.positionPercent(80, 99));
        // await ƒS.Character.hide(characters.death);
        // await ƒS.Character.show(characters.death, characters.death.pose.normal, ƒS.positionPercent(20, 100));
        // await ƒS.update();
...
(function (ACatInLimbo) {
    async function Lake() {
        ...
        if (ACatInLimbo.dataForSave.visitedLake == true) {
            ...
            await ACatInLimbo.ƒS.update(1);
            await ACatInLimbo.ƒS.Speech.tell(ACatInLimbo.characters.protagonist, "Uh, what a beautiful lake!");
            ...
            await ACatInLimbo.ƒS.Character.show(ACatInLimbo.characters.pinkCat, ACatInLimbo.characters.pinkCat.pose.crouchedLookingAway, ACatInLimbo.ƒS.positionPercent(80, 95));
            await ACatInLimbo.ƒS.update(1);
            await ACatInLimbo.ƒS.Speech.tell(ACatInLimbo.characters.pinkCat, "Ah. Hi!");
    ...
    async function Meadow() {
        ...
        switch (firstActionRequest) {
            case firstAction.lookAround:
                ...
                await ACatInLimbo.ƒS.Speech.tell(ACatInLimbo.characters.protagonist, "Why does this cat look so real? Like it's not supposed to be of stone. Maybe if I touch i...");
                await ACatInLimbo.ƒS.update();
        ...
        await ACatInLimbo.ƒS.Speech.tell(ACatInLimbo.characters.protagonist, "You're right, I can't remember anything. From what you're telling me, this place doesn't sound like one I would want to stay in.");
        await ACatInLimbo.ƒS.update();
        await ACatInLimbo.ƒS.Character.hide(ACatInLimbo.characters.pinkCat);
            ...
            case helpSwampCreature.help:
                ...
                switch (getSnailsRequest) {
                    ...
                    case getSnails.getSnails:
                        await ACatInLimbo.ƒS.Speech.tell(ACatInLimbo.characters.protagonist, "Noice. Maybe it's gonna be of use. Please let's move forward now, this place stinks like hell!");
                        ACatInLimbo.dataForSave.catScore += 5;
                        await ACatInLimbo.ƒS.update();
                        await ACatInLimbo.ƒS.Character.hide(ACatInLimbo.characters.pinkCat);
                        await ACatInLimbo.ƒS.Character.show(ACatInLimbo.characters.pinkCat, ACatInLimbo.characters.pinkCat.pose.lovely, ACatInLimbo.ƒS.positionPercent(80, 95));
...
(function (ACatInLimbo) {
    async function BadEndingLostCat() {
        ...
        ACatInLimbo.ƒS.Text.print("You've pissed off the pink cat and it's abandoning you.<br>The second it leaves, you get dizzy, your vision gets blurry and you see things that definitely weren't there before.");
